      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
          ...
          >
            ...
            />
            <path
              d="M599 329.642L147.295 328.849L199.646 245.149L199.897 244.752V60.2876C199.896 58.0486 200.36 55.8315 201.262 53.7629C202.164 51.6943 203.485 49.8147 205.151 48.2315C206.818 46.6483 208.796 45.3924 210.973 44.5357C213.15 43.679 215.483 43.2381 217.839 43.2383H525.951C528.307 43.2381 530.64 43.679 532.817 44.5357C534.994 45.3924 536.972 46.6483 538.639 48.2315C540.305 49.8147 541.626 51.6943 542.528 53.7629C543.43 55.8315 543.894 58.0486 543.894 60.2876V246.022L599 329.642Z"
              fill="#1ED760"
            />
            <path
              d="M217.43 55.1387C215.881 55.1403 214.395 55.726 213.3 56.7671C212.204 57.8082 211.588 59.2198 211.586 60.6922V228.885C211.588 230.357 212.204 231.769 213.3 232.81C214.395 233.851 215.881 234.437 217.43 234.438H528.865C530.414 234.437 531.9 233.851 532.995 232.81C534.091 231.769 534.708 230.357 534.709 228.885V60.6922C534.708 59.2198 534.091 57.8083 532.996 56.7672C531.9 55.726 530.414 55.1404 528.865 55.1387H217.43Z"
              fill="#363636"
            />
            <path
            ...
            />
            <path
              d="M371.895 52.3619C373.97 52.3619 375.652 50.7635 375.652 48.7918C375.652 46.8201 373.97 45.2217 371.895 45.2217C369.82 45.2217 368.138 46.8201 368.138 48.7918C368.138 50.7635 369.82 52.3619 371.895 52.3619Z"
              fill="#363636"
            />
            <path
            ...
            />
            <path
              d="M534.292 111.071C566.571 111.071 592.738 86.2066 592.738 55.5353C592.738 24.864 566.571 0 534.292 0C502.013 0 475.846 24.864 475.846 55.5353C475.846 86.2066 502.013 111.071 534.292 111.071Z"
              fill="#2E2D2D"
            />
            <path
              d="M558.505 79.7327H510.078C509.193 79.7319 508.344 79.3973 507.718 78.8023C507.092 78.2074 506.74 77.4007 506.739 76.5593V48.7916C506.74 47.9502 507.092 47.1436 507.718 46.5486C508.344 45.9537 509.193 45.6191 510.078 45.6182H558.505C559.391 45.6191 560.24 45.9537 560.866 46.5486C561.492 47.1436 561.844 47.9502 561.845 48.7916V76.5593C561.844 77.4007 561.492 78.2074 560.866 78.8023C560.24 79.3973 559.391 79.7319 558.505 79.7327ZM510.078 48.7916V76.5593H558.508L558.505 48.7916L510.078 48.7916Z"
              fill="#1ED760"
            />
            <path
              d="M549.321 48.7917H519.263V36.098C519.263 26.9038 525.584 20.2307 534.292 20.2307C543 20.2307 549.321 26.9038 549.321 36.098L549.321 48.7917ZM522.603 45.6183H545.981V36.098C545.981 28.6241 541.174 23.4042 534.292 23.4042C527.409 23.4042 522.603 28.6242 522.603 36.098L522.603 45.6183Z"
              fill="#1ED760"
            />
            <path
              d="M534.292 65.0556C536.136 65.0556 537.632 63.6348 537.632 61.8822C537.632 60.1295 536.136 58.7087 534.292 58.7087C532.447 58.7087 530.952 60.1295 530.952 61.8822C530.952 63.6348 532.447 65.0556 534.292 65.0556Z"
              fill="#1ED760"
            />
            <path
        ...
        <form
          ...
          className="lg:w-2/6 md:w-1/2 bg-gray-light rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0"
        >
          <h1 className="font-bold text-heading-green text-3xl mb-5">Login</h1>
          <div className="relative mb-4">
            <label htmlFor="username" className="leading-7 text-text-green font-bold text-lg">
              Username
            </label>
            <input
              type="text"
              ...
              className="w-full bg-cool-gray rounded-lg border-gray-300 focus:border-dark-bg focus:ring-2 focus:ring-gray-500 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
          <div className="relative mb-4">
            <label htmlFor="password" className="leading-7 text-text-green font-bold text-lg">
              Password
            </label>
            <input
              type="password"
          ...
          <p className="text-sm font-semibold text-text-green mb-3">
